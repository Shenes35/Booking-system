...
//Declares a constant, () mean this function takes no arguments, { ... } contains the function body, arrow function is syntax
  ...
  //username → The current value of the state (initially ''). setUsername → A function used to update the username state. useState('passenger') → Initializes the state with the string 'passenger'.
