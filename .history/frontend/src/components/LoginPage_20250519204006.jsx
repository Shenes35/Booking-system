...
//Declares a constant, () mean this function takes no arguments, { ... } contains the function body, arrow function is syntax
  ...
  //errors → The current value of the state (initially ''). setUsername → A function used to update the username state. useState('') → Initializes the state with the empty string.
