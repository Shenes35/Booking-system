...
//Declares a constant, () mean this function takes no arguments, { ... } contains the function body, arrow function is syntax
  ...
  //username → The current value of the state (initially ''). set → A function used to update the role state. useState('passenger') → Initializes the state with the string 'passenger'.
