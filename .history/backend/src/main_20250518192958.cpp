...
class Flight {
protected:
//protected is an access specifier ,Members declared as protected are:Accessible within the class itself (like private).

Accessible in derived (child) classes — unlike private.
