...
class Flight {
protected:
//protected is an access specifier ,They are Accessible within the class itself (like private), Accessible in derived (child) classes — unlike privateNot accessible from outside the class (unlike public).
